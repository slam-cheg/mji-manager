...
import { buttonError } from "../../popupFunctions/buttonError.js";
...
export const loadData = (appVariables, availableFunctions, resultsDefectsInputs, representativesInputs) => {
	...
	setRepresentatives(representativesInputs, availableFunctions);
