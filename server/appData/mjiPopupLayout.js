...
<div class="mji-manager-app">
    ...
    <div class="main">
        ...
        ${functions.parser ? '<div class="content content_deactive" id="parser"><form class="form form_parser" action="submit"><div class="form__field"><label class="form__label" for="file">Выберите CSV файл</label><input class="form__input" type="file" id="fileInput" accept=".csv" /></div><button id="processBtnParser" class="form__button">Начать</button><div id="loader" style="display: none"><div id="progressText">Обработано: 0 / 0</div><div style="margin: 10px auto"><div class="loader"></div></div></div></form><script src="libs/mammoth.browser.min.js"></script></div>' : ""}
        ${functions.parserPDF ? '<div class="content content_deactive" id="parserPDF"><form class="form form_parserPDF" action="submit"><div class="form__field"><label class="form__label" for="file">Выберите PDF файл</label><input class="form__input" type="file" id="fileInput" accept=".pdf" /></div><button id="processBtnParserPDF" class="form__button">Начать</button><div id="loader" style="display: none"><div id="progressTextPDF">Обработано: 0 / 0</div><div style="margin: 10px auto"><div class="loader"></div></div></div></form></div>' : ""}
    </div>`;
